...
Precisión: 0.91 — acierta el 91 % al predecir "No Churn".

Recall: 0.82 — detecta el 82 % de los casos reales de "No Churn".

F1-score: 0.86 — buen equilibrio entre precisión y recall.

Clase 1 (Churn):

Precisión: 0.84 — acierta el 84 % al predecir "Churn".

Recall: 0.92 — identifica el 92 % de los casos reales de "Churn".

F1-score: 0.88 — muestra un excelente balance, destacando la capacidad del modelo para detectar clientes que efectivamente se van.

Este modelo terminó con un 0.87 de accuracy, por lo que vemos un resultado similar al del estudio.
